...
**Bookworms visual identity:** The adult Home closed matching card must remain visibly distinguishable from the normal watch matcher through its filled royal-violet gradient, existing gold trim, and its original transparent gold-ring/open-book/play-star crest in `assets/brand/matchapp-bookworms-crest.svg`. Use this bespoke asset, not a stock icon or generic book emoji, on the adult Home only. Keep title legible and crest fully contained at every viewport, preserve the dropdown form and direct watch-field adjacency, and do not change actual book, magazine or movie poster/cover artwork to match this decorative brand icon.
