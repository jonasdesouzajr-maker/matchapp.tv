...
const CONTENT_CATALOG = [
    ...
    { title: "Love Is Blind", year: 2020, country: "United States", countryCode: "US", synopsis: "Singles date and get engaged sight unseen, meeting face-to-face only after saying yes.", platform: "Netflix", cats: ["reality show"], moods: ["romantic","funny"], vibes: ["guilty pleasure","fast-paced binge-worthy"], ratings: ["teen PG-13","any"] },
    ...
    { title: "Love Is Blind: UK", year: 2024, country: "United Kingdom", countryCode: "GB", synopsis: "British singles date and get engaged sight unseen, meeting face-to-face only after saying yes.", platform: "Netflix", cats: ["reality show"], moods: ["romantic","funny"], vibes: ["guilty pleasure","fast-paced binge-worthy"], ratings: ["teen PG-13","any"] },
