...
window.triggerMatch = async function(isSpecificSearch = false) {
    ...
    // Independent official-show metadata after the main verified TMDB source
    // exhausts: only for source-provable adult TV preferences. Never pretend
    // TVmaze proves a selected streaming service, rating or production country.
    if (!isSpecificSearch && !preflight) {
