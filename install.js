...
function configureInstallBrand() {
    ...
    manifest.href = (MATCHAPP_KIDS_INSTALL ? MATCHAPP_KIDS_MANIFEST : (locale === 'pt-BR' ? '/manifest-pt-br.json' : '/manifest.json')) + '?v=' + (MATCHAPP_KIDS_INSTALL ? MATCHAPP_KIDS_INSTALL_VERSION : MATCHAPP_INSTALL_VERSION);
    ...
    touch.href = (MATCHAPP_KIDS_INSTALL ? '/kids/kids-logo.jpeg?v=' + MATCHAPP_KIDS_INSTALL_VERSION : '/assets/brand/matchapp-ai-install-192.png?v=' + MATCHAPP_INSTALL_VERSION);
}
