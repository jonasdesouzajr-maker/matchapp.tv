...
(function(){
  ...
  async function boot(){
    ...
    const primaryAction=document.getElementById('questionnaire-box')||document.getElementById('ma-concierge');const anchor=primaryAction||premiere;if(anchor)anchor.insertAdjacentElement('afterend',section);else main.prepend(section);
