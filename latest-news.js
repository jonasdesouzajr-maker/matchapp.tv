...
(function(){
  ...
  const AUTO_MS=4000;
  const TRUSTED_DOMAINS=['reuters.com','reutersagency.com','cnn.com','hollywoodreporter.com','bbc.com','bbc.co.uk','g1.globo.com','apnews.com','espn.com','espn.com.br','theguardian.com','formula1.com','nba.com','theconversation.com'];
  ...
  async function boot(){
    ...
    const primaryAction=document.getElementById('ebook-matcher-root')||document.getElementById('questionnaire-box')||document.getElementById('ma-concierge');const anchor=primaryAction||premiere;if(anchor)anchor.insertAdjacentElement('afterend',section);else main.prepend(section);
