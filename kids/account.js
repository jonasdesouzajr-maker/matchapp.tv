...
(function(){
 ...
 function loadCatalogMedia(){
  ...
  const s=document.createElement('script');s.src='/catalog-media.js?v=20260918-detail2';s.defer=true;s.async=false;s.dataset.kidsCatalogMedia='1';document.head.appendChild(s);
 }
