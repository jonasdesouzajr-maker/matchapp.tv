...
(function(){'use strict';
  if(!document.getElementById('ma-wall-fill-20260923')){
    ...
    s.textContent="html body:not(.kids-body) .poster-wall{position:fixed!important;inset:0!important;width:100%!important;height:100%!important;min-height:100dvh!important;z-index:0!important;pointer-events:none!important;overflow:hidden!important}html body:not(.kids-body) .poster-wall-grid{position:absolute!important;inset:-36% -30%!important;display:grid!important;grid-template-columns:repeat(8,minmax(0,1fr))!important;gap:8px!important;transform:rotate(-11deg) scale(1.24)!important;opacity:.56!important;animation:none!important;will-change:auto!important}html body:not(.kids-body) .poster-wall-tile{position:relative!important;top:auto!important;left:auto!important;right:auto!important;bottom:auto!important;width:auto!important;aspect-ratio:2/3!important;opacity:1!important;transform:none!important;animation:none!important;will-change:auto!important}html body:not(.kids-body) .poster-wall-tile>img{width:100%!important;height:100%!important;object-fit:contain!important;object-position:center center!important}@media(max-width:700px){html body:not(.kids-body) .poster-wall-grid{inset:-30% -42%!important;grid-template-columns:repeat(5,minmax(0,1fr))!important;transform:rotate(-9deg) scale(1.32)!important;opacity:.48!important}}html body .install-btn{min-height:32px!important;height:32px!important;padding:0 12px!important;font-size:12px!important;border-radius:999px!important}@media(min-width:901px){html body .install-wrap{display:none!important}}";
