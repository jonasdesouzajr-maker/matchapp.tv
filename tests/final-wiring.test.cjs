...
test('final wiring activates title integrity, no-repeat history, speed guard and human conversation',()=>{
  ...
  assert.match(speed,/150000/,'long source verification has a bounded 150-second recovery watchdog');
  assert.match(speed,/__matchappMatchRunId/,'late completions must not charge or overwrite a new match');
