...
test('Home startup avoids delayed boot locks, stale cache keys and duplicate header owners',()=>{
 ...
 const versions={'build-meta.js':'20260920-design4','matchapp-ia.js':'20260920-homebrand4','matchapp-ia.css':'20260921-layout3','settings.js':'20260920-freeze8','app.js':'20260920-speed2','catalog-media.js':'20260920-freeze-final1','lazy.js':'20260921-hero1'};
...
test('Home header is visible without JavaScript and avoids filtered 8K SVGs',()=>{
 ...
 assert.match(html,/\/matchapp-ia\.css\?v=20260921-layout3/);
