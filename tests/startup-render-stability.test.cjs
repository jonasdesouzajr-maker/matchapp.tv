...
test('Home startup avoids delayed boot locks, stale cache keys and duplicate header owners',()=>{
 ...
 assert.ok(html.includes('/catalog-media.js?v=20260926-coverrace1'),'stale shared runtime catalog-media.js');
 assert.ok(html.includes('/app.js?v=20260926-resultclose-cover1'),'stale shared runtime app.js');
