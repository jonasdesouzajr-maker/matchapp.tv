...
(function () {
  ...
  // Temporary compatibility for the large legacy app.js call site. Match is
  // always routed to consume_match(); Ask AI remains on its own credit path.
  // Remove this only in the same release that directly migrates app.js.
  setTimeout(() => {
