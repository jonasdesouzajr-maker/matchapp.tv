...
window.MATCHAPP_BUILD = '2026.09.18.6';
...
(function () {
  ...
  function loadHomeRuntimeFixes() {
    ...
    const script = document.createElement('script');
    script.src = '/marquee-autoplay.js?v=20260918-bidirectional1&b=' + encodeURIComponent(window.MATCHAPP_BUILD || '2026.09.18.6'); script.defer = true; script.dataset.matchappMarqueeAutoplay = '1';    document.head.appendChild(script);
  }
