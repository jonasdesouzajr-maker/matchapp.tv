...
window.MATCHAPP_BUILD = '2026.09.18.4';
...
(function () {
  ...
  function loadHomeRuntimeFixes() {
    ...
    const script = document.createElement('script');
    script.src = '/marquee-autoplay.js?v=20260916-flow2&b=' + encodeURIComponent(window.MATCHAPP_BUILD || '2026.09.18.4'); script.defer = true; script.dataset.matchappMarqueeAutoplay = '1';    document.head.appendChild(script);
  }
