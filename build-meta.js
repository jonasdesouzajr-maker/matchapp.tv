...
(function () {
  ...
  function loadHomeRuntimeFixes() {
    ...
    const script = document.createElement('script');
    script.src = '/marquee-autoplay.js?v=20260919-touchglide1&b=' + encodeURIComponent(window.MATCHAPP_BUILD || '2026.09.19.1'); script.defer = true; script.dataset.matchappMarqueeAutoplay = '1';    document.head.appendChild(script);
  }
