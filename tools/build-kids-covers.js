...
for (const item of catalogue) {
  ...
  const categoryTheme = {animals:'forest',family:'home',learning:'robot',funny:'blocks',adventure:'sky',music:'music',bedtime:'sky'};
  const motif = motifs[themes[item.title] || categoryTheme[item.cats[0]] || 'sky'].replaceAll('ACCENT',accent).replaceAll('DEEP',deep);
