...
const style=`:root{color-scheme:dark}*{box-sizing:border-box}body{margin:0;background:#21113e;color:#fcf7ff;font:18px/1.65 system-ui}header,main,footer{width:min(1050px,92%);margin:auto}header{padding:24px 0;display:flex;gap:24px;align-items:center}header img{width:64px;border-radius:50%}a{color:#ffda8c}h1{font-size:clamp(2rem,5vw,3.5rem);line-height:1.1}h2{line-height:1.3}.title-hero{display:grid;grid-template-columns:minmax(150px,280px) 1fr;gap:32px;align-items:start;margin:32px 0}.title-hero img{width:100%;height:auto;object-fit:contain;object-position:center;max-width:100%;border-radius:24px}.watch{display:inline-block;background:#ffda8c;color:#21113e;border-radius:14px;padding:14px 20px;margin:8px;text-decoration:none;font-weight:700}.list{display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:24px}.list article{background:#362052;border-radius:20px;padding:20px}.list img{width:100%;max-width:160px;height:auto;object-fit:contain;object-position:center;border-radius:16px}footer{padding:48px 0}.note{color:#e5d8f1}.seo-facts{display:flex;flex-wrap:wrap;gap:8px;margin:18px 0}.seo-facts span{padding:6px 10px;border-radius:999px;background:#362052;color:#f4e9ff;font-size:.86rem}.source-note{padding:14px 16px;border-left:4px solid #ffda8c;background:#2d1848;border-radius:10px}.matcher-link{display:inline-block;margin:14px 0 6px;font-weight:800}a:focus-visible{outline:3px solid #a0e9ed;outline-offset:4px}[hidden]{display:none!important}@media(max-width:600px){.title-hero{grid-template-columns:1fr}.title-hero img{max-width:200px}}`;
